...
<div class="card form-card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.destination.update', $destination->id) }}"
              method="POST"
            ...
            <div class="form-group">
                ...
                <textarea name="description"
                          rows="3"
                          class="form-control"
                          placeholder="Masukkan deskripsi...">{{ old('description', $destination->description) }}</textarea>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="time"
                           name="open_time"
                           class="form-control"
                           value="{{ old('open_time', \Illuminate\Support\Carbon::parse($destination->open_time)->format('H:i')) }}"
                           required>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="time"
                           name="close_time"
                           class="form-control"
                           value="{{ old('close_time', \Illuminate\Support\Carbon::parse($destination->close_time)->format('H:i')) }}"
                           required>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <input type="url"
                       name="video_url"
                       class="form-control"
                       value="{{ old('video_url', $destination->video_url) }}"
                       placeholder="https://...">
            </div>
