...
<head>
    ...
    <title>Destinasi — HarauTrip</title>
...
<header class="fixed top-0 inset-x-0 z-50 bg-cream border-b border-line">
    <div class="max-w-7xl mx-auto px-6 lg:px-10 h-20 flex items-center justify-between gap-4">
        ...
        <nav class="hidden lg:flex items-center gap-1 bg-white/70 px-2 py-1.5 rounded-full border border-line">
            ...
            <a href="{{ route('landing.destinations') }}" class="px-4 py-1.5 rounded-full text-sm font-semibold bg-primary-light text-primary">Destinasi</a>
            @auth
...
<main class="pt-20">
    <section class="max-w-7xl mx-auto px-6 lg:px-10 py-16">
        <div class="mb-10">
            <span class="text-accent font-bold text-xs uppercase tracking-widest">Jelajahi Harau</span>
            <h1 class="font-display font-extrabold text-3xl lg:text-4xl text-ink mt-3">Semua Destinasi</h1>
            <p class="text-ink-soft mt-3 max-w-2xl">Temukan tempat-tempat menarik di Lembah Harau dan sekitarnya.</p>
        </div>
