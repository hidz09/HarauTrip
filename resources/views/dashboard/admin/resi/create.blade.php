...
@section('title', 'Buat Resi')
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Tambah Resi</h3>
        </div>
        <!-- form start -->
        <form id="quickForm" method="POST" action="{{ route('admin.resi.store') }}">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_pengirim" class="form-control" rows="2" placeholder="Alamat Lengkap" required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_penerima" class="form-control" rows="2" placeholder="Alamat Lengkap" required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="jenis_pengiriman" class="form-control" required>
                        ...
                        <option value="Instant">Instant Courier</option>
                    </select>
                </div>
